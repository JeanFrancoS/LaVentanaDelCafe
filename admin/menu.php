...
<?php if($_POST){
    ...
    $sql="INSERT INTO `producto` (`Id`, `Imagen`, `Descripcion`) 
                        ...
                        <div class="formTotal">
                            <div class="formulario">
                                ...
                                <div class="infoCard">
                                    ...
                                    <!-- <input required class="form-control" type="text" name="tipoAlimento" id="tipoAlimento"> -->
                                    <select name="tipoAlimento" class="form-control">
                                        <option value="sinValor" class="form-control">Seleccione una opción...</option>
                                        <?php foreach($alimentos as $alimento){ ?>
                                        <option value=<?php echo $alimento['Nombre'];?> class="form-control"><?php echo $alimento['Nombre'];}?></option>
                                    </select>
                                </div>
                                
                                <div class="infoCard">
                                    <label for="Temperatura">Temperatura</label>
                                    <!-- <input required class="form-control" type="text" name="temperatura" id="temperatura"> -->
                                ...
                                <div class="infoCard">
                                    <label for="Dulce">Dulce<input class="form-control chk" type="checkbox" name="dulce" id="dulce"></label>
                                </div>
                                <div class="infoCard">
                ...
                <table class="table">
                    ...
                    <tbody >
                        ...
                        <tr >
                            ...
                            <td><img width="200px" src="../assets/img/productos/<?php echo $producto['Imagen'];?>" alt="">  </td>
