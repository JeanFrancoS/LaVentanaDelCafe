...
<?php if($_POST){#si hay envio de datos, los inserto en la base de datos  
    ...
    move_uploaded_file($imagen_temporal,"../assets/img/Local/".$imagen);

    #creo una instancia(objeto) de la clase de conexion
    $conexion = new conexion();
    $sql="INSERT INTO `imagenesLocal` (`Id`, `Imagen`, `Descripcion`) 
 ...
 if($_GET){
   ...
   if(isset($_GET['borrar'])){
        ...
        $imagen = $conexion->consultar("SELECT Imagen FROM `imagenesLocal` WHERE `imagenesLocal`.`Id`=".$id);
        #la borramos de la carpeta 
        unlink("../assets/img/".$imagen[0]['Imagen']);
        
        $sql ="UPDATE `imagenesLocal` SET `imagenesLocal`.`estado` = 0 WHERE `imagenesLocal`.`Id` =".$id; 
  ...
  $conexion = new conexion();
  $productos = $conexion->consultar("SELECT *
                                        FROM `imagenesLocal` as `P`
                                        WHERE `P`.`Estado` = 1");
?> 
    <main>
                    ...
                    <form action="galeria.php" method="POST" enctype="multipart/form-data">
                        <div class="formTotal">
                            <div class="formulario">
                                ...
                                <div>                        
                                    <input class="btn bEnviar" type="submit" value="Enviar">
                                </div>
                            </div>
                            <div class="lugarImagen">
                                <div class="infoCard">
                                    <label for="Imagen">Imagen</label>
                                    <img src="../assets/img/GetImagenProducto.jpg" alt="" id="imgSinCargar" class = "imgSinCargar">
        ...
        <div class="prodIng">
            <h2 class="titListado">Listado de imagenes ingresadas: </h2>
                ...
                <table class="table">
                    ...
                    <tbody >
                        ...
                        <tr >
                            ...
                            <td> <img width="200px" src="../assets/img/Local/<?php echo $producto['Imagen'];?>" alt="">  </td>
                            <td class="texto"><?php echo $producto['Descripcion'];?></td>
                            <td><a name="modificar" id="modificar" class="logoModificar" href="?modificar=<?php echo $producto['Id'];?>">   
                            ...
                            <a name="eliminar" id="eliminar" class="" href="?borrar=<?php echo $producto['Id'];?>"><svg xmlns="http://www.w3.org/2000/svg" height="1em" 
                                viewBox="0 0 448 512" alt="Eliminar" class="logoEliminar" ><path producto="logoEliminar" alt="Eliminar" d="M135.2 17.7L128 32H32C14.3 32 0 46.3 
